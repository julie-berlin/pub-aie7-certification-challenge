...
class RAGASEvaluationService:
    ...
    def load_test_dataset(self, dataset_path: str = "test_dataset.json") -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error("Failed to load test dataset", extra={"error": str(e)})
            raise
    ...
    async def run_full_evaluation(self, dataset_path: str = "test_dataset.json") -> Dict[str, Any]:
